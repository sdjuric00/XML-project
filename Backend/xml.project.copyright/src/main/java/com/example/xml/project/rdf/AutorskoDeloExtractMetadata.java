...
import static com.example.xml.project.rdf.RdfConstants.AUTORSKO_DELO_NAMED_GRAPH_URI;
import static com.example.xml.project.rdf.RdfConstants.AUTORSKO_DELO_NAMESPACE;
...
//        broj prijave, datum, referenca, email za punomocnika, email za podnosioca, naslov, vrsta dela, forma zapisa, prerada naslov
        ...
        for (int i = 0; i < autori.size(); i++) {
            String str = "autor" + i;
            Property autor = model.createProperty(PREDICATE_NAMESPACE, str);
        ...
        Property naslov = model.createProperty(PREDICATE_NAMESPACE, "naslov");
        ...
        Property forma_zapisa = model.createProperty(PREDICATE_NAMESPACE, "forma_zapisa");
        ...
        Property vrsta_dela = model.createProperty(PREDICATE_NAMESPACE, "vrsta_dela");
        ...
        if (!zahtevAutorskaDela.getAutorsko_delo().getPodaci_o_naslovu_prerada().getNaslov().equals((""))) {
            Property naslov_prerada = model.createProperty(PREDICATE_NAMESPACE, "naslov_prerada");
