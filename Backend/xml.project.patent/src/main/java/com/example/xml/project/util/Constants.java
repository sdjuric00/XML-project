...
public class Constants {
    ...
    public static final String PATENTI_SCHEMA = "./data/P-1.xsd";
    public static final String PATENTI_NEW_XML = "./data/P-1_new.xml";
    public static final String RESENJE_SCHEMA = "./data/Resenje.xsd";

    public static final String PATENT_NAMESPACE = "http://www.patent/patent";
