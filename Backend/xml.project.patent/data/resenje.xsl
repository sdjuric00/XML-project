                    ...
                    <p style="text-align: center; margin-top: 0.3rem;">
                        <xsl:choose>
                            <xsl:when test="//razlog_odbijanja">
                                <span style="font-weight: bold; font-size: 1.5rem; color: red;">Zahtev je odbijen!</span>
                            </xsl:when>
                            <xsl:otherwise>
                                <span style="font-weight: bold; font-size: 1.5rem; color: green;">Zahtev je prihvacen, cestitamo!</span>
                            </xsl:otherwise>
                        </xsl:choose>
                    </p>
                    <br />
