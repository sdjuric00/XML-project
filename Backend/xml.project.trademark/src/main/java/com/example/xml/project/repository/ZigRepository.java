...
public class ZigRepository extends BasicXMLRepository {
    private static final String collectionId = "/db/xml/zahtevi-zig";
    private static final String schemaName = "http://www.zig/zig";

    public List<ZahtevZig> pronadjiRezultateOsnovnePretrage(List<String> parameters) throws Exception {
        String xPathIzraz = "/zahtev_za_priznanje_ziga";
        List<ZahtevZig> listaRez = new ArrayList<ZahtevZig>();
        try {
